...
mod tests {
    ...
    fn destino_padrao_bare_usa_diretorio_atual() {
        ...
        assert_eq!(destino_padrao(Path::new("bare.7z"), None), PathBuf::from("."));
    }

    #[test]
    fn destino_padrao_com_dir_usa_parent() {
        assert_eq!(destino_padrao(Path::new("dir/a.7z"), None), PathBuf::from("dir"));
        assert_eq!(destino_padrao(Path::new("/x/a.7z"), None), PathBuf::from("/x"));
    }
